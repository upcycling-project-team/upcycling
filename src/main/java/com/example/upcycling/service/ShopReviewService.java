...
public class ShopReviewService {
    ...
    public List<ShopReviewDto> findReviewList2(Long productNumber, Criteria criteria){
        List<ShopReviewDto> shopReviewList = shopReviewMapper.selectReviewList2(productNumber, criteria);
